...
CREATE TABLE `billetes`(`id` int(11) NOT NULL DEFAULT '0',`descripcion` varchar(30) NOT NULL DEFAULT '',`valor` double NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8
...
CREATE TABLE `caja` (`numero` bigint(11) NOT NULL DEFAULT '0',`numeroSucursal` int(11) NOT NULL DEFAULT '0',`numeroUsuario` int(11) NOT NULL DEFAULT '0',`tipoMovimiento` int(11) NOT NULL DEFAULT '0',`saldoinicial` double NOT NULL DEFAULT '0',`estado` int(11) NOT NULL DEFAULT '0',`tipo` int(11) NOT NULL DEFAULT '0',`saldofinal` double DEFAULT NULL,`fechacierre` varchar(30) DEFAULT NULL,`diferencia` double DEFAULT NULL,`fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8
...
CREATE TABLE `coeficienteslistas` (`id` int(11) NOT NULL DEFAULT '0',`coeficiente` double NOT NULL DEFAULT '0',`descripcion` varchar(30) NOT NULL DEFAULT '') ENGINE=InnoDB DEFAULT CHARSET=utf8

--
-- Volcado de datos para la tabla `coeficienteslistas`
--

INSERT INTO `coeficienteslistas` (`id`, `coeficiente`,`descripcion`) VALUES(1, 1, 'base')
...
CREATE TABLE `combo` (`id` int(11) NOT NULL DEFAULT '0',`fecha` date DEFAULT NULL,'idarticulo` int(11) NOT NULL DEFAULT '0',`cantidad` double DEFAULT NULL,`articulopadre` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8
...
CREATE TABLE `comprobantes` (`numero` int(11) NOT NULL DEFAULT '0',`descripcion` varchar(4) NOT NULL DEFAULT '',`destinatarioCondicion` int(11) NOT NULL DEFAULT '0',`descargaStock` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8
...
CREATE TABLE `depositos` (`numero` int(11) NOT NULL DEFAULT '0',`descripcion` varchar(100) NOT NULL DEFAULT '',`direccion` varchar(200) NOT NULL DEFAULT '',`telefono` varchar(200) NOT NULL DEFAULT '') ENGINE=InnoDB DEFAULT CHARSET=utf8

--
-- Volcado de datos para la tabla `depositos`
--

INSERT INTO `depositos` (`numero`, `descripcion`, `direccion`,`telefono`) VALUES(1, 'casa central', 'lamadradid 2552', '4555555')
...
CREATE TABLE `fallas` (`st` text NOT NULL,`estado` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8
...
CREATE TABLE `movimientosproveedores` (`numeroProveedor` int(11) NOT NULL DEFAULT '0',`monto` double NOT NULL DEFAULT '0',`pagado` int(11) DEFAULT NULL,`numeroComprobante` varchar(30) DEFAULT NULL,`idRemito` int(11) DEFAULT NULL,`idUsuario` int(11) NOT NULL DEFAULT '0',`idCaja` int(11) NOT NULL DEFAULT '0',`fechaPago` varchar(20) DEFAULT NULL,`tipoComprobante` int(11) DEFAULT NULL,`idSucursal` int(11) NOT NULL DEFAULT '0',`estado` int(11) DEFAULT NULL,`id` int(11) NOT NULL,`fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8
...
CREATE TABLE `movimientosusuarios` (`numeroUsuario` int(11) NOT NULL DEFAULT '0',`tipoAcceso` int(11) DEFAULT NULL,`entrada` varchar(30) NOT NULL DEFAULT '',`estado` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8
...
CREATE TABLE `rubros` (`id` int(11) NOT NULL,`descripcion` varchar(70) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1

--
-- Volcado de datos para la tabla `rubros`
--

INSERT INTO `rubros` (`id`, `descripcion`) VALUES(1, 'ARTICULOS GENERALES')
...
CREATE TABLE `sucursal` (`numero` int(11) NOT NULL DEFAULT '0',`descripcion` varchar(100) NOT NULL DEFAULT '',`direccion` varchar(100) NOT NULL DEFAULT '',`telefono` varchar(100) NOT NULL DEFAULT '',`deposito` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8

--
-- Volcado de datos para la tabla `sucursal`
--

INSERT INTO `sucursal` (`numero`, `descripcion`, `direccion`,`telefono`, `deposito`) VALUES(1, 'POCO PRECIO 1', '1', '', 1)
...
CREATE TABLE `tipoacceso` (`numero` int(11) NOT NULL DEFAULT '0',`descripcion` varchar(20) NOT NULL DEFAULT '',`nivel` int(11) NOT NULL DEFAULT '0',`menu1` int(11) NOT NULL DEFAULT '0',`menu2` int(11) NOT NULL DEFAULT '0',`menu3` int(11) NOT NULL DEFAULT '0',`menu4` int(11) NOT NULL DEFAULT '0',`menu5` int(11) NOT NULL DEFAULT '0',`menu6` int(11) NOT NULL DEFAULT '0',`menu7` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8

--
-- Volcado de datos para la tabla `tipoacceso`
--

INSERT INTO `tipoacceso` (`numero`, `descripcion`, `nivel`,`menu1`, `menu2`, `menu3`, `menu4`, `menu5`, `menu6`, `menu7`) VALUES(1, 'administrador', 1, 1, 1, 1, 1, 1, 1, 1),(2, 'cajero', 2, 0, 0, 1, 1, 0, 1, 0),(3, 'prueba', 3, 0, 0, 1, 1, 0, 0, 0)
...
CREATE TABLE `tipocomprobantes` (`numero` int(11) NOT NULL DEFAULT '0',`descripcion` varchar(50) NOT NULL DEFAULT '',`numeroActivo` int(11) NOT NULL DEFAULT '0',`numeroSucursal` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8

--
-- Volcado de datos para la tabla `tipocomprobantes`
--

INSERT INTO `tipocomprobantes` (`numero`, `descripcion`,`numeroActivo`, `numeroSucursal`) VALUES(1, 'ticket', 5, 1),(2, 'FCA A', 0, 1),(3, 'remito proveedor', 0, 1),(4, 'remito interno', 0, 1),(5, 'factura proveedor A', 0, 1),(6, 'factura proveedor', 0, 1),(7, 'ticket', 0, 2),(8, 'FCA A', 0, 2),(9, 'ticket', 0, 3),(10, 'FCA A', 0, 3),(11, 'recibo de pago', 0, 1),(12, 'mov caja', 36, 0),(13, 'gasto fijo', 0, 1),(14, 'ticket', 0, 4),(15, 'FCA A', 0, 4),(16, 'ticket', 0, 5),(17, 'FCA A', 0, 5),(18, 'remito de ajuste de stock', 0, 1),(19, 'TICKET', 0, 7),(20, 'FACTURA PROVEEDOR', 0, 7),(21, 'FCA A', 0, 7),(22, 'ticket', 0, 6),(23, 'FCA A', 0, 6),(81, 'TFA', 0, 1),(82, 'TFB', 0, 1),(112, 'NCA', 0, 1),(113, 'NCB', 0, 1)
...
CREATE TABLE `tipomovimientos` (`ID` int(11) NOT NULL DEFAULT '0',`DESCRIPCION` varchar(30) NOT NULL DEFAULT '',`DESTINOOPERACION` int(11) NOT NULL DEFAULT '0',`MULTIPLOOP` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8

--
-- Volcado de datos para la tabla `tipomovimientos`
--

INSERT INTO `tipomovimientos` (`ID`, `DESCRIPCION`,'DESTINOOPERACION`, `MULTIPLOOP`) VALUES(1, 'Ventas', 1, 1),(2, 'Compras', 1, 1),(3, 'Devolucion de Ventas', 1, 1),(4, 'Retiro Efectivo', 2, -1),(5, 'Recepcion de mercaderias', 1, 1),(6, 'Traslado de mercaderias', 1, 1),(7, 'Ingreso de Caja', 2, 1),(8, 'Devolucion de compras', 1, 1),(9, 'saldo inicial', 2, 1),(10, 'Cerrar Caja', 2, -1),(11, 'Pago a Proveedores', 2, -1),(12, 'Gastos de Caja', 2, -1),(13, 'Cobro de Cuenta Corriente Clie', 2, 1),(14, 'ajuste de stock', 1, 1),(15, 'ajuste de saldo', 1, 1)
...
CREATE TABLE `usuarios` (`numero` int(11) NOT NULL DEFAULT '0',`nombre` varchar(70) NOT NULL DEFAULT '',`direccion` varchar(200) NOT NULL DEFAULT '',`localidad` varchar(70) NOT NULL DEFAULT '',`telefono` varchar(100) NOT NULL DEFAULT '',`mail` varchar(100) NOT NULL DEFAULT '',`nombreUsuario` varchar(100) NOT NULL DEFAULT '',`clave` varchar(100) NOT NULL DEFAULT '',`autorizacion` int(11) NOT NULL DEFAULT '0',`numeroTipoAcceso` int(11) NOT NULL DEFAULT '0',`sucursal` int(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8

--
-- Volcado de datos para la tabla `usuarios`
--

INSERT INTO `usuarios` (`numero`, `nombre`, `direccion`,`localidad`, `telefono`, `mail`, `nombreUsuario`, `clave`, 'autorizacion`, `numeroTipoAcceso`, `sucursal`) VALUES(1, 'administrador', '', '', '', '', '', 'null', 1, 1, 1),(2, 'ELIEL', '', '', '', '', 'ELIEL', 'ELIEL', 2, 2, 7)
...
--
ALTER TABLE `billetes` ADD PRIMARY KEY (`id`)

--
-- Indices de la tabla `caja`
--
ALTER TABLE `caja` ADD PRIMARY KEY (`numero`)

--
-- Indices de la tabla `coeficienteslistas`
--
ALTER TABLE `coeficienteslistas` ADD PRIMARY KEY (`id`)

--
-- Indices de la tabla `combo`
--
ALTER TABLE `combo` ADD PRIMARY KEY (`id`)

--
-- Indices de la tabla `comprobantes`
--
ALTER TABLE `comprobantes` ADD PRIMARY KEY (`numero`)

--
-- Indices de la tabla `depositos`
--
ALTER TABLE `depositos` ADD PRIMARY KEY (`numero`)

--
-- Indices de la tabla `fiscal`
--
ALTER TABLE `fiscal` ADD PRIMARY KEY (`id`), ADD KEY `numero_2` (`numero`)

--
-- Indices de la tabla `ivaventas`
--
ALTER TABLE `ivaventas` ADD PRIMARY KEY (`id`)

--
-- Indices de la tabla `listcli`
--
ALTER TABLE `listcli` ADD PRIMARY KEY (`id`), ADD KEY `id` (`id`), ADD KEY `codmmd` (`codmmd`)

--
-- Indices de la tabla `movimientosarticulos`
--
ALTER TABLE `movimientosarticulos` ADD PRIMARY KEY (`id`)

--
-- Indices de la tabla `movimientoscaja`
--
ALTER TABLE `movimientoscaja` ADD PRIMARY KEY (`id`), ADD KEY 'fecha` (`fecha`)

--
-- Indices de la tabla `movimientosclientes`
--
ALTER TABLE `movimientosclientes` ADD PRIMARY KEY (`id`)

--
-- Indices de la tabla `movimientosproveedores`
--
ALTER TABLE `movimientosproveedores` ADD PRIMARY KEY (`id`), ADD KEY `fecha` (`fecha`)
...
--
ALTER TABLE `sucursal` ADD PRIMARY KEY (`numero`)

--
-- Indices de la tabla `tipoacceso`
--
ALTER TABLE `tipoacceso` ADD PRIMARY KEY (`numero`)

--
-- Indices de la tabla `tipocomprobantes`
--
ALTER TABLE `tipocomprobantes` ADD PRIMARY KEY (`numero`)

--
-- Indices de la tabla `tipomovimientos`
--
ALTER TABLE `tipomovimientos` ADD PRIMARY KEY (`ID`)

--
-- Indices de la tabla `usuarios`
--
ALTER TABLE `usuarios` ADD PRIMARY KEY (`numero`)
...
--
ALTER TABLE `fiscal` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT
--
-- AUTO_INCREMENT de la tabla `ivaventas`
--
ALTER TABLE `ivaventas` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT
--
-- AUTO_INCREMENT de la tabla `listcli`
--
ALTER TABLE `listcli` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4
--
-- AUTO_INCREMENT de la tabla `movimientosarticulos`
--
ALTER TABLE `movimientosarticulos` MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT
--
-- AUTO_INCREMENT de la tabla `movimientoscaja`
--
ALTER TABLE `movimientoscaja` MODIFY `id` bigint(11) NOT NULL AUTO_INCREMENT
--
-- AUTO_INCREMENT de la tabla `movimientosclientes`
--
ALTER TABLE `movimientosclientes` MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT
--
-- AUTO_INCREMENT de la tabla `movimientosproveedores`
--
ALTER TABLE `movimientosproveedores` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT
--
-- AUTO_INCREMENT de la tabla `proveedores`
--
ALTER TABLE `proveedores` MODIFY `numero` int(11) NOT NULL AUTO_INCREMENT
--
-- AUTO_INCREMENT de la tabla `rubros`
--
ALTER TABLE `rubros` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9
