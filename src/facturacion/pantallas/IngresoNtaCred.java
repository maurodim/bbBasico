 ...
 * @author hernan
 */
public class IngresoNtaCred extends javax.swing.JInternalFrame {
	...
	String ano=Integer.toString(c2.get(Calendar.YEAR));
        ...
        int comprobanteTipo=9;
        //System.out.println("COMPROBANTEEEEEEE "+comprobanteTipo);
        if(cliT.getCondicionIva().equals("RI "))comprobanteTipo=10;
        ...
        if(montoTotal == 0.00){
            ...
            try {
                ...
                Logger.getLogger(IngresoNtaCred.class.getName()).log(Level.SEVERE, null, ex1);
            }finally{
                         try {
        ...
        comprobante.setMontoTotal(montoTotal * (-1));
        int noFacturar=0;
...
//                montoTotal=montoTotal + montoTotalX;
    ...
    private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameActivated
       //jLabel6.setText(cliT.getRazonSocial());
